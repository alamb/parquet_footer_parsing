...
|                                   | Metadata            | PageIndex (Column/Offset) | Metadata            | PageIndex (Column/Offset) | Metadata                       | PageIndex (Column/Offset)      |
+=========================================================================================================================================================================================================+
|  Float 100 cols 20 row groups     | 2.566288ms          | 4.123198ms                | 796.756µs           | 684.034µs                 | 636.182µs                      | 0ns                            |
|-----------------------------------+---------------------+---------------------------+---------------------+---------------------------+--------------------------------+--------------------------------|
|  Float 1000 cols 20 row groups    | 25.895227ms         | 42.341734ms               | 7.972799ms          | 6.682272ms                | 6.41151ms                      | 0ns                            |
|-----------------------------------+---------------------+---------------------------+---------------------+---------------------------+--------------------------------+--------------------------------|
|  Float 10000 cols 20 row groups   | 276.774864ms        | 509.465427ms              | 86.70366ms          | 84.486892ms               | 69.098354ms                    | 0ns                            |
|-----------------------------------+---------------------+---------------------------+---------------------+---------------------------+--------------------------------+--------------------------------|
|  Float 100000 cols 20 row groups  | 2.855637398s        | 5.918709802s              | 875.855802ms        | 853.64883ms               | 699.769343ms                   | 0ns                            |
|-----------------------------------+---------------------+---------------------------+---------------------+---------------------------+--------------------------------+--------------------------------|
|  String 100 cols 20 row groups    | 2.259842ms          | 3.809164ms                | 962.081µs           | 850.22µs                  | 627.781µs                      | 0ns                            |
|-----------------------------------+---------------------+---------------------------+---------------------+---------------------------+--------------------------------+--------------------------------|
|  String 1000 cols 20 row groups   | 22.97403ms          | 39.091372ms               | 9.131941ms          | 8.369599ms                | 6.374651ms                     | 0ns                            |
|-----------------------------------+---------------------+---------------------------+---------------------+---------------------------+--------------------------------+--------------------------------|
|  String 10000 cols 20 row groups  | 246.342284ms        | 440.506986ms              | 99.284968ms         | 96.088133ms               | 68.698424ms                    | 0ns                            |
|-----------------------------------+---------------------+---------------------------+---------------------+---------------------------+--------------------------------+--------------------------------|
|  String 100000 cols 20 row groups | 2.57461705s         | 4.850964762s              | 987.595674ms        | 932.900664ms              | 684.414417ms                   | 0ns                            |
+-----------------------------------+---------------------+---------------------------+---------------------+---------------------------+--------------------------------+--------------------------------+
CSV output:
Description,Parse Time Arrow 56 Metadata (ms),Parse Time Arrow 56 PageIndex (Column/Offset) (ms),Parse Time Arrow 57 Metadata (ms),Parse Time Arrow 57 PageIndex (Column/Offset) (ms),Parse Time Arrow 57 (no stats) Metadata (ms),Parse Time Arrow 57 (no stats) PageIndex (Column/Offset) (ms)
 Float 100 cols 20 row groups,2,4,0,0,0,0
 Float 1000 cols 20 row groups,25,42,7,6,6,0
 Float 10000 cols 20 row groups,276,509,86,84,69,0
 Float 100000 cols 20 row groups,2855,5918,875,853,699,0
 String 100 cols 20 row groups,2,3,0,0,0,0
 String 1000 cols 20 row groups,22,39,9,8,6,0
 String 10000 cols 20 row groups,246,440,99,96,68,0
 String 100000 cols 20 row groups,2574,4850,987,932,684,0
```
